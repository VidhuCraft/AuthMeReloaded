...
public final class Settings extends YamlConfiguration {
	...
	public static Boolean isPermissionCheckEnabled, isRegistrationEnabled,
			...
			isForceExactSpawnEnabled, isSaveQuitLocationEnabled,
			isForceSurvivalModeEnabled, isResetInventoryIfCreative,
			isCachingEnabled, isKickOnWrongPasswordEnabled,
			getEnablePasswordVerifier, protectInventoryBeforeLogInEnabled,
			isBackupActivated, isBackupOnStart, isBackupOnStop,
			enablePasspartu, isStopEnabled, reloadSupport, rakamakUseIp,
			noConsoleSpam, removePassword, displayOtherAccounts, useCaptcha,
			emailRegistration, multiverse, notifications, chestshop, bungee,
	...
	public static String getNickRegex, getUnloggedinGroup, getMySQLHost,
			...
			getMySQLlastlocWorld, getMySQLColumnisActivated, getMySQLColumnActivationKey;
	...
	public void loadConfigOptions() {
		...
		getMySQLColumnisActivated = configFile.getString("DataSource.mySQLColumnisActivated"
				, "isActivated");
		
		getMySQLColumnActivationKey = configFile.getString("DataSource.mySQLColumnActivationKey"
				, "activationKey");
		...
		useMultiThreading = configFile.getBoolean(
				"Performances.useMultiThreading", false);
	...
	public void mergeConfig() {
		...
		if (!contains("ExternalBoardOptions.mySQLOtherUsernameColumns"))
			set("ExternalBoardOptions.mySQLOtherUsernameColumns",
					new ArrayList<String>());
	...
	private static HashAlgorithm getPasswordHash() {
		...
		try {
			return PasswordSecurity.HashAlgorithm.valueOf(configFile.getString(
					key, "SHA256").toUpperCase());
